...
- [Download Faster R-CNN ResNet Weights](http://download.tensorflow.org/models/object_detection/faster_rcnn_resnet50_coco_2018_01_28.tar.gz)

## Configuration

- [Download Faster R-CNN ResNet Configuration](https://github.com/opencv/opencv_extra/raw/4.x/testdata/dnn/faster_rcnn_resnet50_coco_2018_01_28.pbtxt)
